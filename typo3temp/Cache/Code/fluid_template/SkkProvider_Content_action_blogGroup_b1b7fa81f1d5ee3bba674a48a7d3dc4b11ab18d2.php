<?php
class FluidCache_SkkProvider_Content_action_blogGroup_b1b7fa81f1d5ee3bba674a48a7d3dc4b11ab18d2 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments22 = array();
$arguments22['value'] = $currentVariableContainer->getOrNull('item');
...
return (!is_string($value24) ? $value24 : htmlspecialchars($value24, ($arguments22['keepQuotes'] ? ENT_NOQUOTES : ENT_COMPAT), ($arguments22['encoding'] !== NULL ? $arguments22['encoding'] : \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate::resolveDefaultEncoding()), $arguments22['doubleEncode']));
};
...
$arguments48 = array();
$arguments48['parameter'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('item'), 'uid', $renderingContext);
$arguments48['target'] = '';
$arguments48['class'] = '';
$arguments48['title'] = '';
...
$output19 .= TYPO3\CMS\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments25, $renderChildrenClosure26, $renderingContext);
...
$arguments81['maxDepth'] = 8;
$arguments81['plainText'] = false;
$arguments81['ansiColors'] = false;
$arguments81['inline'] = false;
$arguments81['blacklistedClassNames'] = NULL;
$arguments81['blacklistedPropertyNames'] = NULL;
$renderChildrenClosure82 = function() use ($renderingContext, $self) {
$currentVariableContainer = $renderingContext->getTemplateVariableContainer();
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments83 = array();
$arguments83['value'] = $currentVariableContainer->getOrNull('item');
...
return (!is_string($value85) ? $value85 : htmlspecialchars($value85, ($arguments83['keepQuotes'] ? ENT_NOQUOTES : ENT_COMPAT), ($arguments83['encoding'] !== NULL ? $arguments83['encoding'] : \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate::resolveDefaultEncoding()), $arguments83['doubleEncode']));
};

$output80 .= TYPO3\CMS\Fluid\ViewHelpers\DebugViewHelper::renderStatic($arguments81, $renderChildrenClosure82, $renderingContext);
...
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Link\TypolinkViewHelper
$arguments109 = array();
$arguments109['parameter'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('item'), 'uid', $renderingContext);
$arguments109['target'] = '';
$arguments109['class'] = '';
$arguments109['title'] = '';
...
$output80 .= TYPO3\CMS\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments86, $renderChildrenClosure87, $renderingContext);
