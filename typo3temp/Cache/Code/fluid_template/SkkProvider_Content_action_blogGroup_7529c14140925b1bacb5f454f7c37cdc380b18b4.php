<?php
class FluidCache_SkkProvider_Content_action_blogGroup_7529c14140925b1bacb5f454f7c37cdc380b18b4 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments31['maxDepth'] = 8;
$arguments31['plainText'] = false;
$arguments31['ansiColors'] = false;
$arguments31['inline'] = false;
$arguments31['blacklistedClassNames'] = NULL;
$arguments31['blacklistedPropertyNames'] = NULL;
$renderChildrenClosure32 = function() use ($renderingContext, $self) {
$currentVariableContainer = $renderingContext->getTemplateVariableContainer();
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments33 = array();
$arguments33['value'] = $currentVariableContainer->getOrNull('content');
...
$output22 .= TYPO3\CMS\Fluid\ViewHelpers\DebugViewHelper::renderStatic($arguments31, $renderChildrenClosure32, $renderingContext);
...
$output22 .= FluidTYPO3\Flux\ViewHelpers\Form\DataViewHelper::renderStatic($arguments36, $renderChildrenClosure37, $renderingContext);
...
$arguments92['maxDepth'] = 8;
$arguments92['plainText'] = false;
$arguments92['ansiColors'] = false;
$arguments92['inline'] = false;
$arguments92['blacklistedClassNames'] = NULL;
$arguments92['blacklistedPropertyNames'] = NULL;
$renderChildrenClosure93 = function() use ($renderingContext, $self) {
$currentVariableContainer = $renderingContext->getTemplateVariableContainer();
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments94 = array();
$arguments94['value'] = $currentVariableContainer->getOrNull('content');
...
return (!is_string($value96) ? $value96 : htmlspecialchars($value96, ($arguments94['keepQuotes'] ? ENT_NOQUOTES : ENT_COMPAT), ($arguments94['encoding'] !== NULL ? $arguments94['encoding'] : \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate::resolveDefaultEncoding()), $arguments94['doubleEncode']));
};

$output83 .= TYPO3\CMS\Fluid\ViewHelpers\DebugViewHelper::renderStatic($arguments92, $renderChildrenClosure93, $renderingContext);
...
$output83 .= FluidTYPO3\Flux\ViewHelpers\Form\DataViewHelper::renderStatic($arguments97, $renderChildrenClosure98, $renderingContext);
